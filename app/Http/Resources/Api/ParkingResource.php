...
class ParkingResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        $CRserial = 'C.R : 4030264321' . PHP_EOL;
        ...
        if ($this->ends_at != null) {
            ...
            $resource['print_text'] = $invoice . $id . $company_name . $CRserial . $tax_registar . $starts_at . $ends_at  . $cost . $total . $web;
        } else {

            $resource['print_text'] = $id . $company_name . $CRserial . $tax_registar . $starts_at . $web;
        }
